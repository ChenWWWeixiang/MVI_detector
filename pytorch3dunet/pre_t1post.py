...
output_path='/mnt/data1/mvi2/h5_t1post'
output_path2='/mnt/data1/mvi2/nrrd_t1post'
...
for p in tqdm(patients):
    C=[]
    seg1=glob.glob(os.path.join(raw_path,p+'_'+MOD+'*'))+glob.glob(os.path.join(raw_path,p+'_'+MOD.upper()+'*'))
    if len(seg1)==0:
        print(p,'no seg!')
        continue
